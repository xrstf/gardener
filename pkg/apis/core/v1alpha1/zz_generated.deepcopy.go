...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BastionShootReference) DeepCopyInto(out *BastionShootReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BastionShootReference.
func (in *BastionShootReference) DeepCopy() *BastionShootReference {
	if in == nil {
		return nil
	}
	out := new(BastionShootReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BastionStatus) DeepCopyInto(out *BastionStatus) {
	*out = *in
	...
	in.LastHeartbeatTimestamp.DeepCopyInto(&out.LastHeartbeatTimestamp)
