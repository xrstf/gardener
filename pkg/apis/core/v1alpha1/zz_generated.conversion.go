...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BastionShootReference)(nil), (*core.BastionShootReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BastionShootReference_To_core_BastionShootReference(a.(*BastionShootReference), b.(*core.BastionShootReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.BastionShootReference)(nil), (*BastionShootReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_BastionShootReference_To_v1alpha1_BastionShootReference(a.(*core.BastionShootReference), b.(*BastionShootReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BastionShootReference_To_core_BastionShootReference(in *BastionShootReference, out *core.BastionShootReference, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_v1alpha1_BastionShootReference_To_core_BastionShootReference is an autogenerated conversion function.
func Convert_v1alpha1_BastionShootReference_To_core_BastionShootReference(in *BastionShootReference, out *core.BastionShootReference, s conversion.Scope) error {
	return autoConvert_v1alpha1_BastionShootReference_To_core_BastionShootReference(in, out, s)
}

func autoConvert_core_BastionShootReference_To_v1alpha1_BastionShootReference(in *core.BastionShootReference, out *BastionShootReference, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_core_BastionShootReference_To_v1alpha1_BastionShootReference is an autogenerated conversion function.
func Convert_core_BastionShootReference_To_v1alpha1_BastionShootReference(in *core.BastionShootReference, out *BastionShootReference, s conversion.Scope) error {
	return autoConvert_core_BastionShootReference_To_v1alpha1_BastionShootReference(in, out, s)
}

func autoConvert_v1alpha1_BastionSpec_To_core_BastionSpec(in *BastionSpec, out *core.BastionSpec, s conversion.Scope) error {
	if err := Convert_v1alpha1_BastionShootReference_To_core_BastionShootReference(&in.ShootRef, &out.ShootRef, s); err != nil {
		return err
	}
...
func autoConvert_core_BastionSpec_To_v1alpha1_BastionSpec(in *core.BastionSpec, out *BastionSpec, s conversion.Scope) error {
	if err := Convert_core_BastionShootReference_To_v1alpha1_BastionShootReference(&in.ShootRef, &out.ShootRef, s); err != nil {
		return err
	}
	out.SSHPublicKey = in.SSHPublicKey
